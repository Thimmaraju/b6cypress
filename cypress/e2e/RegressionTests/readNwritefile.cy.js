...
describe('Automation - Write file and Read file ', function () {
    ...
    it.only('Cypress Test Case - Write file example', function () {
        ...
        cy.writeFile('cypress/fixtures/module1/test4.txt', "Thimmaraju\n")
    ...
    it.only('Cypress Test Case - Validation of Data both Text file and Json ', function () {
        ...
        cy.readFile('cypress/fixtures/module1/test4.txt').should('contain','Thimmaraju');

        cy.readFile('cypress/fixtures/module1/test4.txt').should('eq','Thimmaraju\nCypress Trainer')       
    })
