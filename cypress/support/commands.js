...
Cypress.Commands.add("validateAttribute", (element, attributename, value) => {
    if (element.includes("//")) {
        cy.xpath(element).should('have.attr', attributename, value );
    }
    else {
        cy.get(element).should('have.attr', attributename, value );
    }
})
